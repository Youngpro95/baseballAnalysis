...
# print(gameListData)
# print(today)
print_games_for_today(gameListData, 'Wednesday, July 24, 2024')
# try:
#     # 크롤링할 웹 페이지 URL
#     today = datetime.now().strftime('%A, %B %d, %Y').replace(' 0', ' ')
...
#     #             game_lines = []  # h3.text에 대한 게임 정보를 저장할 리스트
#     #
#     #             for p in p_elements:
#     #                 game_info = p.text
#     #
...
#     #
#     #                     # 시간 문자열을 판단하여 game_time_korea를 결정
#     #                     if time_part[0] == 'TBD':
#     #                         game_time_korea = 'TBD'
#     #                     else:
...
#     #                         game_line["preview_link"] = preview_link  # 링크를 game_line에 추가
#     #                     except:
#     #                         pass  # Preview 링크가 없는 경우 예외 처리
#     #
#     #                     game_lines.append(game_line)  # game_line을 리스트에 추가
#     #
#     #             # h3.text와 game_lines를 딕셔너리로 저장
#     #             if game_lines:  # game_lines 리스트가 비어 있지 않은 경우만 추가
#     #                 preview_links_dict.append({h3.text: game_lines})
#     #
#     #     # 결과 출력
#     #     # print(preview_links_dict)
#     #     # with open('schedule_data.py', 'w') as file:
#     #     #     file.write(f"gameListData = {json.dumps(preview_links_dict, indent=4)}")
#     # Preview 링크 방문 및 HTML 소스 출력 후 내용 분석
#
#     # for test in gameListData:
#     #     print(test.Object)
